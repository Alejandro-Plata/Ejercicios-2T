...
public class Tablero {
    ...
    /**
     * Constructor específico para tests, con todas las luces apagadas
     */
    public Tablero () {
    	setLongitud(5);
     ...
     */
    public int estadoAleatorio() { return Math.random() < 0.5 ? 0 : 1; } //Podría utilizar Math.Round, pero así lo veo más limpio
